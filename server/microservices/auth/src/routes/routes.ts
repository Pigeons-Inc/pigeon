...
export function RegisterRoutes(app: express.Router) {
  ...
  app.post(
    ...
    function AuthController_register(request: any, response: any, next: any) {
      const args = {
        body: { in: 'body', name: 'body', required: true, ref: 'BodyProps' },
      };
  ...
  app.get(
    ...
    function AuthController_validate(request: any, response: any, next: any) {
      const args = {
        authorization: {
          default: '',
          in: 'header',
      ...
      try {
        ...
        const promise = controller.validate.apply(
          controller,
          validatedArgs as any
        );
        promiseHandler(controller, promise, response, 200, next);
  ...
  app.put(
    ...
    function AuthController_activate(request: any, response: any, next: any) {
      const args = {
      ...
      try {
        ...
        const promise = controller.activate.apply(
          controller,
          validatedArgs as any
        );
        promiseHandler(controller, promise, response, 200, next);
